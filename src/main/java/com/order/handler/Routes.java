...
public class Routes {
    ...
    public static final String API_THOUGHTS = "/api/thoughts";
    public static final String API_THOUGHT_BY = "/api/thought/by";
